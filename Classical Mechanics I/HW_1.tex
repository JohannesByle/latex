...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \end{gather*}
            \item
            Simply plugging in the variables $x=r\cos\theta$ and $\dot{x}=r\sin\theta$:
            \begin{gather*}
                \dot{E}=-\left(\left(r\cos\theta\right)^2+\left(r\sin\theta\right)^2-1\right)r\sin\theta-r\cos\theta
            \end{gather*}
            Solving for $\dot{r}$:
            \begin{gather*}
                \begin{gather*}
                    \frac{d\dot{E}}{dr}=-\left(\left(r\cos\theta\right)^2+\left(r\sin\theta\right)^2-1\right)r\sin\theta-r\cos\theta
                \end{gather*}
            \end{gather*}
        \end{enumerate}
    \end{enumerate}
