...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item
            \begin{gather}
                L=\frac{1}{2}m\frac{L-y}{2L}\dot{y}^2-mgy_{cm}\\
                L=m\frac{L-y}{4L}\dot{y}^2-mg\left[ \frac{L^2+2yL-y^2}{4L}\right]
            \end{gather}
            \item
            Since we know the initial conditions we can solve this using conservation of energy:
            \begin{gather}
                m\frac{L-y}{4L}\dot{y}^2+mgy_{cm}=mg\frac{L}{4}\\
                m\frac{L-y}{4L}\dot{y}^2+mg\left[ \frac{L^2+2yL-y^2}{4L}\right]=mg\frac{L}{4}\\
                \dot{y}=\pm\frac{\sqrt{g y^2-2 g L y}}{\sqrt{L-y}}
            \end{gather}
            \item
            We can differentiate the answer to the previous section to find the acceleration:
            \begin{gather}
                \ddot{y}=\frac{\dot{y} \sqrt{g y^2-2 g L y}}{2 (L-y)^{3/2}}+\frac{2 g y \dot{y}-2 g L \dot{y}}{2 \sqrt{L-y} \sqrt{g y^2-2 g L y(t)}}
            \end{gather}
